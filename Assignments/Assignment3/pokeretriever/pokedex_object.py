...
class PokedexObject(ABC):
    """ Represents Pokedex information. """
...
class Pokemon(PokedexObject):
    """ Represents info about a Pokemon. """

    class PokemonStat:
        """ A Pokemon's stat. """
        def __init__(self, **kwargs):
            """
            :param kwargs: a dict from JSON object
            """
...
class Ability(PokedexObject):
    """ Detailed info about a Pokemon's Ability. """
    def __init__(self, **kwargs):
        """
        :param kwargs: a dict from JSON object
        """
...
class Stat(PokedexObject):
    """ Detailed info about a Pokemon's Stat. """
    def __init__(self, **kwargs):
        """
        :param kwargs: a dict from JSON object
        """
...
class Move(PokedexObject):
    """ Detailed info about a Pokemon's Move. """
    def __init__(self, **kwargs):
        """
        :param kwargs: a dict from JSON object
        """
